  ...
  return (
    <>
      <div className="hero-main-container">
        <Header />
        <div className=" pt-[62px] pr-[289px] pb-[0px] pl-[289px] text-center max-[992px]:px-0 max-[992px]:container  max-[992px]:mx-auto">
        ...
        <div className=" pr-[416px] pl-[418px] pb-[0px] text-center max-[992px]:px-0 max-[992px]:container  max-[992px]:mx-auto">
