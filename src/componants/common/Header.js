            ...
            >
              <ul className="flex bg-transparent flex-col p-4 max-[768px]:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 lg:flex-row lg:space-x-8 lg:mt-0 lg:border-0  dark:bg-gray-800 lg:dark:bg-gray-900 dark:border-gray-700 border-none">
                ...
                <li className="">
                  <a
                    href="#dddedewd"
                    className="block py-2 pl-3 pr-4 text-white rounded lg:hover:bg-transparent  max-[768px]:pl-0  dark:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 font-Gilroy-Medium text-[18px] ml-[65px] max-[992px]:ml-0"
                  >
                    Shop
                  </a>
                </li>
