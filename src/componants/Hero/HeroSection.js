  ...
  return (
    <>
      <div className="hero-main-container">
        <Header />
        <div className=" pt-[62px] pr-[16.5vw] pb-[0px] pl-[16.5vw] text-center max-[992px]:px-0 max-[992px]:container  max-[992px]:mx-auto">
        ...
        <div className=" pr-[25vw] pl-[25vw] pb-[0px] text-center max-[992px]:px-0 max-[992px]:container  max-[992px]:mx-auto">
